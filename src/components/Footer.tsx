export default function Footer() {
  return (
    <footer className=" bg-[#FFFFFF] p-10 mt-16 px-6 py-12 md:px-12 lg:px-20 my-10 border-t border-[#F1F5F9]">
      <div className="grid grid-cols-1 md:grid-cols-2 mx-auto px-10 py-7">
        {/* Left 6 columns */}
      ...
      <div className="my-10 border-t border-[#F1F5F9]"></div>
