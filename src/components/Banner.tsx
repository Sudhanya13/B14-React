...
export default function Banner() {
  return (
    <div className="container mx-16 flex items-center justify-between py-5 px-16 ">
      <div className="flex flex-col gap-6 text-left max-w-xl">
        <h1 className="font-bold leading-tight">
          <span className="text-black text-7xl">Build Your Ideal</span>

          <br />

          <span className="text-7xl font-bold bg-gradient-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] bg-clip-text text-transparent">
            Development Stack
          </span>
        </h1>

        <p className="text-[16px] text-[#475569] max-w-[600px]">
          Explore Frontend, Backend, Database tooling options and compare them
          side by side and put together the stack that fits your next project.
        </p>

        <div className="flex gap-3">
          <button className="btn h-[38px] w-[180px] border-none bg-gradient-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] text-white">
            Explore Technologies
          </button>

          <button className="btn h-[38px] w-[200px] bg-white">
            Learn More
          </button>
        </div>
      </div>
